...
<section>
	<div class="container mt-5 pb-4">
		...
		<form class="container-fluid" action="" method="post">
			...
			<div class="form-group row justify-content-center">
				<div class="col-md-2 px-0">
					<label for="cargo" class="d-inline-block text-center w-100 normal-font">Cargo</label>
				</div>
				<div class="col-md-4 px-0">
					<input type="text" name="cargo" id="function" class="form-control" placeholder="Função">							
				</div>
			</div>
			<div class="form-group row justify-content-center">
				<div class="col-md-2 px-0">
