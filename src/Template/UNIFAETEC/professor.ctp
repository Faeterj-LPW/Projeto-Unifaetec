	...
	<body id="body">
			...
			<div class="form">
				<form action="" method="post">
					<table width="100%" class="table-borderless">
					  ...
					  <tr>
						<td class="rightlevel righttext">Área</td>
						<td class="lefttext">
							<div class="form-group">
								<input type="text" class="form-control form-control-lg" name="area" id="area" placeholder="Atuação" style="width:335px;">
							</div>
						</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td class="rightlevel righttext">Currículo Lattes</td>
						<td class="lefttext">
							<div class="form-group">
								<input type="text" class="form-control form-control-lg" name="lattes" id="lattes" placeholder="Link para o currículo" style="width:335px;">
							</div>								
						</td>
					  </tr>
					  <tr>
		...
		<footer id="footer">
			<div class="container-fluid">
				<div class="copyright">
					<small><strong>Faetec-RJ</strong> - Secretaria de Ciência, Tecnologia e Inovação.</small><a id="simple" href="funcionario.php">próxima >></a>	
				</div>
			</div>
		</footer>
		<!-- Fim do Rodapé -->
