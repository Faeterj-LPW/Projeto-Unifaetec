...
<html lang="pt-BR">
	<head>
		<title>Cadastro de prpfessor</title>
		<meta charset="utf-8">
	...
	<body id="body">
			...
			<div class="form">
				<form action="" method="post">
					<table width="100%" class="table-borderless">
					  ...
					  <tr>
						<td class="rightlevel righttext">Cargo</td>
						<td class="lefttext">
							<div class="form-group">
								<input type="text" class="form-control form-control-lg" name="cargo" id="cargo" placeholder="Função" style="width:335px;">
							</div>
						</td>
					  </tr>
					  <tr>
		...
		<footer id="footer">
			<div class="container-fluid">
				<div class="copyright">
					<small><strong>Faetec-RJ</strong> - Secretaria de Ciência, Tecnologia e Inovação.</small><a id="simple" href="trabalhos.php">próxima >></a>	
				</div>
			</div>
		</footer>
		<!-- Fim do Rodapé -->
