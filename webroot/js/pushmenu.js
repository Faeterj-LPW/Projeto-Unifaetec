...
(function(w, $){
	...
	var menutoggler = '<div class="menutoggler" title="Abrir o Menu"><i style="color:#fff;" class="fa fa-bars"></i></div>' // FIxed menu Toggler HTML. Set to empty string '' to disable
